...
export READONLY=
export CREDENTIAL=
SOURCE=mongodb+srv://$READONLY@orderbook.ibu3n.mongodb.net
TARGET=mongodb+srv://$CREDENTIAL@orderbook2.ibu3n.mongodb.net

export READONLY=
export CREDENTIAL=
SOURCE=mongodb+srv://$READONLY@data-platform-v2.ibu3n.mongodb.net
TARGET=mongodb+srv://$CREDENTIAL@data-platform.ibu3n.mongodb.net

export READONLY=
export CREDENTIAL=
SOURCE=mongodb://$READONLY@data-api-a.mongodb.nftgo.io:27017,data-api-b.mongodb.nftgo.io:27017,data-api-c.mongodb.nftgo.io:27017
TARGET=mongodb://$CREDENTIAL@10.3.98.107:27017,10.3.96.105:27017,10.3.99.211:27017

export READONLY=
export CREDENTIAL=
SOURCE=mongodb://$READONLY@bot-prod.cluster-cono0v2vbnhv.ap-southeast-1.docdb.amazonaws.com:27017
